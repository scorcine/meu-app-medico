...
const HTML_PARADA_CARDIO = `
  <nav class="emerg-algo-nav" aria-label="Algoritmos de PCR">
    <a href="#bls-adulto">Adulto – BLS 2025</a>
    <a href="#acls-adulto">Adulto – ACLS</a>
    <a href="#pals-ped">Pediátrico – PALS</a>
    <a href="#bradicardia">Ritmo &lt; 50 bpm</a>
    <a href="#taquicardia">Taquicardia instável</a>
    <a href="#rosc">ROSC pós-PCR</a>
  </nav>

  <section class="emerg-algo-block" id="bls-adulto">
    <h3>Adulto – BLS 2025</h3>
  ...
  <section class="emerg-algo-block" id="acls-adulto">
    <h3>Adulto – ACLS</h3>
  ...
  <section class="emerg-algo-block" id="pals-ped">
    <h3>Pediátrico – PALS</h3>
  ...
  <section class="emerg-algo-block" id="bradicardia">
    <h3>Ritmo lentificado (&lt; 50 bpm)</h3>
  ...
  <section class="emerg-algo-block" id="taquicardia">
    <h3>Taquicardia instável</h3>
  ...
  <section class="emerg-algo-block" id="rosc">
    <h3>ROSC pós-PCR</h3>
    ...
    <p class="emerg-note">Referência: diretrizes AHA 2020/2025 (BLS/ACLS/PALS). Adaptar à protocolo institucional e disponibilidade local.</p>
  </section>
`;
