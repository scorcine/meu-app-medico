...
function defaultActiveHomeCards () {
  return [
    ...
    { section: 'flashcards', icon: '🃏', name: 'Flashcards', desc: '11 temas · 390 cards — sepse, IAM, cardiologia (90), gasometria e mais.', visible: true, enabled: true, comingSoon: false, pediatricAux: false, color: '#db2777', colorBg: '#fdf2f8' }
  ];
}
