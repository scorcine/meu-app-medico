...
function defaultActiveHomeCards () {
  return [
    ...
    { section: 'receituario', icon: '🏠', name: 'Tratamento para casa', desc: 'Sugestões VO · receita ambulatorial · CRM na Minha conta.', visible: true, enabled: true, comingSoon: false, pediatricAux: false, color: '#0d6efd', colorBg: '#eff6ff' },
