...
const PS_DRUG_META = {
  ...
  nacl_3: { name: 'NaCl 3% (salina hipertônica)', classes: ['electrolyte'] },
  nacl_20: { name: 'NaCl 20%', classes: ['electrolyte'] },
...
const PS_DRUG_ALIASES = [
  ...
  ['nacl_3', ['nacl 3%', 'sf 3%', 'salina hipertonica', 'salina hipertônica']],
  ['nacl_20', ['nacl 20%', 'cloreto de sodio 20%', 'cloreto de sódio 20%']],
